...
void *rkmedia_vi_face_thread(void *args) 
{
  ...
  static char *model_path_2 = "/demo/bin/mobilefacenet.rknn";
  string face_name = "";
  // Load RKNN Model
  ...
  while (!atk_face_recognition_quit) 
  {
    ...
    for (int i = 0; i < detect_result_group.count; i++)
    {
      ...
      */
      ...
      putText(orig_img, "fps:", cv::Point(20, 1200), FONT_HERSHEY_SIMPLEX, 2, Scalar(0, 255, 0), 6, 8, false);
      ...
      putText(orig_img, std::to_string(fps), cv::Point(200, 1200), FONT_HERSHEY_SIMPLEX, 2, Scalar(0, 255, 0), 6, 8, false);
